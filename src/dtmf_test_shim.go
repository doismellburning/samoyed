...
func dtmf_test_main(t *testing.T) {
	...
	my_audio_config.adev[ACHAN2ADEV(C.int(c))].defined = 1
	my_audio_config.adev[ACHAN2ADEV(C.int(c))].samples_per_sec = 44100
	...
	my_audio_config.adev[ACHAN2ADEV(C.int(c))].num_channels = 1
	my_audio_config.adev[ACHAN2ADEV(C.int(c))].bits_per_sample = 8
