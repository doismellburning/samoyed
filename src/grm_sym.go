...
const (
	...
	*/
	...
	/*
	   ...
	   ---------------------------------------------------------------
	*/
	sym_begin_custom = 7680 /* first user customizable symbol */ //nolint:unused
	sym_end_custom   = 8191 /* last user customizable symbol */  //nolint:unused
	/*
	   ---------------------------------------------------------------
	   Land symbols
	   ---------------------------------------------------------------
