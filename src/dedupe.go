...
type historyEntry struct {
	...
	checksum int /* Some sort of checksum for the source, destination, and information. Is is not used anywhere else. */
...
func dedupe_remember(pp *packet_t, channel int) {
	...
	history[insert_next].checksum = int(ax25_dedupe_crc(pp))
