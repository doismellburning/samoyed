...
const MIN_IP_PORT_NUMBER = C.MIN_IP_PORT_NUMBER
const MAX_IP_PORT_NUMBER = C.MAX_IP_PORT_NUMBER
...
const DEFAULT_DEDUPE = C.DEFAULT_DEDUPE
const DEFAULT_AGWPE_PORT = C.DEFAULT_AGWPE_PORT
const DEFAULT_KISS_PORT = C.DEFAULT_KISS_PORT
const DEFAULT_IGATE_PORT = C.DEFAULT_IGATE_PORT
