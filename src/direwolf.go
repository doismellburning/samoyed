...
// #cgo CFLAGS: -I../external/geotranz -I../external/misc -DMAJOR_VERSION=0 -DMINOR_VERSION=0 -DUSE_CM108 -DUSE_AVAHI_CLIENT -DUSE_HAMLIB
// #cgo LDFLAGS: -lm -ludev -lavahi-common -lavahi-client -lhamlib
import "C"
