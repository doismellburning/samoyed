...
func Test_TTUser(t *testing.T) {
	...
	tt_user_heard("TEST1", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_heard("TEST2", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_heard("TEST3", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_heard("TEST4", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_heard("WB2OSZ", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_heard("K2H", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "", ' ', "!T99!")
	tt_user_dump()

	tt_user_heard("679", 12, 'J', 'A', "", 37.25, -71.75, maybe.Just(0), "", " ", " ", ' ', "!T99!")
	tt_user_heard("WB2OSZ", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "146.520MHz", "", "", ' ', "!T99!")
	tt_user_heard("WB1GOF", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "146.955MHz", "074", "", ' ', "!T99!")
	tt_user_heard("679", 12, 'J', 'A', "", G_UNKNOWN, G_UNKNOWN, maybe.Just(0), "", "", "Hello, world", '9', "!T99!")
	tt_user_dump()
}
